...
/**
 * Mockito spy-based integration tests for {@link Cotrn00cProgram}.
 *
...
class Cotrn00cProgramIT {
    ...
    static Stream<TestCaseData> testCases() throws IOException {
        InputStream is = Cotrn00cProgramIT.class.getResourceAsStream("/test_store.jsonl");
        if (is == null) {
            return Stream.empty();
        }
    ...
    void testWithMockitoSpy(TestCaseData tc) {
        ...
        Cotrn00cProgram program = new Cotrn00cProgram(spyStubs);
