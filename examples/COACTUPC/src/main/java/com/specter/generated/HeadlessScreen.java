 ...
 * </ul>
 */
public class HeadlessScreen implements TerminalScreen {
    ...
    public HeadlessScreen(List<TerminalScreen.Field> fields) {
    ...
    public void sendMap(ProgramState state) throws IOException {
        ...
        for (TerminalScreen.Field field : fields) {
            if (field.type() == TerminalScreen.FieldType.INPUT
