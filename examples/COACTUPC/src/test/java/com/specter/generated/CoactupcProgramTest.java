...
/**
 * Generated integration tests for CoactupcProgram.
 *
...
class CoactupcProgramTest {
    ...
    void testRunCompletes() {
        CoactupcProgram program = new CoactupcProgram();
    ...
    void testDefaultState() {
        Map<String, Object> defaults = CoactupcProgram.defaultState();
    ...
    static Stream<TestCaseData> testCases() throws IOException {
        InputStream is = CoactupcProgramTest.class.getResourceAsStream("/test_store.jsonl");
        if (is == null) {
            return Stream.empty();
        }
