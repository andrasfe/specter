...
/**
 * Mockito spy-based integration tests for {@link Copaua0cProgram}.
 *
...
class Copaua0cProgramIT {
    ...
    static Stream<TestCaseData> testCases() throws IOException {
        InputStream is = Copaua0cProgramIT.class.getResourceAsStream("/test_store.jsonl");
        if (is == null) {
            return Stream.empty();
        }
    ...
    void testWithMockitoSpy(TestCaseData tc) {
        ...
        Copaua0cProgram program = new Copaua0cProgram(spyStubs);
