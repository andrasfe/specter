...
/**
 * Interactive terminal entrypoint for {@link Cousr00cProgram}.
 *
 ...
 */
public class TerminalMain_COUSR00C {

    public static void main(String[] args) throws IOException {
        List<CicsScreen.Field> layout = ScreenLayout_COUSR00C.FIELDS;
        ...
        try {
            ...
            while (running) {
                try {
                    Cousr00cProgram program =
                            new Cousr00cProgram(stubs);
                    program.run(state);
