...
public class ScreenLayout_COTRN01C {
    ...
    public static final List<CicsScreen.Field> FIELDS = List.of(
        ...
        new CicsScreen.Field("TRNIDINI", 4, 30, 20, CicsScreen.FieldType.INPUT, "Trnidin", false),
        new CicsScreen.Field("TRNIDI", 5, 30, 20, CicsScreen.FieldType.INPUT, "Trnid", false),
        new CicsScreen.Field("CARDNUMI", 6, 30, 20, CicsScreen.FieldType.INPUT, "Cardnum", false),
