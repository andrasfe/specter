...
/**
 * Interactive terminal entrypoint for {@link Cobil00cProgram}.
 *
 ...
 */
public class TerminalMain_COBIL00C {

    public static void main(String[] args) throws IOException {
        List<CicsScreen.Field> layout = ScreenLayout_COBIL00C.FIELDS;
        ...
        try {
            ...
            while (running) {
                try {
                    Cobil00cProgram program =
                            new Cobil00cProgram(stubs);
                    program.run(state);
