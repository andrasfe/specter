...
/**
 * Interactive terminal entrypoint for {@link Cousr03cProgram}.
 *
 ...
 */
public class TerminalMain_COUSR03C {

    public static void main(String[] args) throws IOException {
        List<CicsScreen.Field> layout = ScreenLayout_COUSR03C.FIELDS;
        ...
        state.put("WS-PGMNAME", "COUSR03C");
        state.put("LIT-THISTRANID", "COUS");
        state.put("LIT-THISPGM", "COUSR03C");
        state.put("LIT-THISMAP", "COUSR3A");
        state.put("LIT-THISMAPSET", "COUSR3");
        state.put("LIT-MENUPGM", "COMEN01C");
        state.put("LIT-MENUTRANID", "COME");
        state.put("CCDA-TITLE01", "Credit Card Demo Application");
        state.put("CCDA-TITLE02", "COUSR03C - Account Update");
        ...
        try {
            ...
            while (running) {
                try {
                    Cousr03cProgram program =
                            new Cousr03cProgram(stubs);
                    program.run(state);
