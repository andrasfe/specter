...
/**
 * Interactive terminal entrypoint for {@link Comen01cProgram}.
 *
 ...
 */
public class TerminalMain_COMEN01C {

    public static void main(String[] args) throws IOException {
        List<CicsScreen.Field> layout = ScreenLayout_COMEN01C.FIELDS;
        ...
        try {
            ...
            while (running) {
                try {
                    Comen01cProgram program =
                            new Comen01cProgram(stubs);
                    program.run(state);
