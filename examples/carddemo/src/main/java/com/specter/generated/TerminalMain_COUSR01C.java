...
/**
 * Interactive terminal entrypoint for {@link Cousr01cProgram}.
 *
 ...
 */
public class TerminalMain_COUSR01C {

    public static void main(String[] args) throws IOException {
        List<CicsScreen.Field> layout = ScreenLayout_COUSR01C.FIELDS;
        ...
        try {
            ...
            while (running) {
                try {
                    Cousr01cProgram program =
                            new Cousr01cProgram(stubs);
                    program.run(state);
