...
/**
 * Interactive terminal entrypoint for {@link Coadm01cProgram}.
 *
 ...
 */
public class TerminalMain_COADM01C {

    public static void main(String[] args) throws IOException {
        List<CicsScreen.Field> layout = ScreenLayout_COADM01C.FIELDS;
        ...
        state.put("WS-TRANID", "COAD");
        state.put("WS-PGMNAME", "COADM01C");
        state.put("LIT-THISTRANID", "COAD");
        state.put("LIT-THISPGM", "COADM01C");
        state.put("LIT-THISMAP", "COADM1A");
        state.put("LIT-THISMAPSET", "COADM1");
        state.put("LIT-MENUPGM", "COMEN01C");
        state.put("LIT-MENUTRANID", "COME");
        state.put("CCDA-TITLE01", "Credit Card Demo Application");
        state.put("CCDA-TITLE02", "COADM01C - Account Update");
        ...
        try {
            ...
            while (running) {
                try {
                    Coadm01cProgram program =
                            new Coadm01cProgram(stubs);
                    program.run(state);
