...
/**
 * Interactive terminal entrypoint for {@link Cotrn01cProgram}.
 *
 ...
 */
public class TerminalMain_COTRN01C {

    public static void main(String[] args) throws IOException {
        List<CicsScreen.Field> layout = ScreenLayout_COTRN01C.FIELDS;
        ...
        try {
            ...
            while (running) {
                try {
                    Cotrn01cProgram program =
                            new Cotrn01cProgram(stubs);
                    program.run(state);
