...
public class ScreenLayout_COUSR01C {
    ...
    public static final List<CicsScreen.Field> FIELDS = List.of(
        ...
        new CicsScreen.Field("FNAMEI", 4, 30, 20, CicsScreen.FieldType.INPUT, "Fname", false),
        new CicsScreen.Field("LNAMEI", 5, 30, 20, CicsScreen.FieldType.INPUT, "Lname", false),
        new CicsScreen.Field("USERIDI", 6, 30, 20, CicsScreen.FieldType.INPUT, "User ID", false),
