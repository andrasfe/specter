...
/**
 * Interactive terminal entrypoint for {@link Cousr02cProgram}.
 *
 ...
 */
public class TerminalMain_COUSR02C {

    public static void main(String[] args) throws IOException {
        List<CicsScreen.Field> layout = ScreenLayout_COUSR02C.FIELDS;
        ...
        state.put("WS-PGMNAME", "COUSR02C");
        state.put("LIT-THISTRANID", "COUS");
        state.put("LIT-THISPGM", "COUSR02C");
        state.put("LIT-THISMAP", "COUSR2A");
        state.put("LIT-THISMAPSET", "COUSR2");
        state.put("LIT-MENUPGM", "COMEN01C");
        state.put("LIT-MENUTRANID", "COME");
        state.put("CCDA-TITLE01", "Credit Card Demo Application");
        state.put("CCDA-TITLE02", "COUSR02C - Account Update");
        ...
        try {
            ...
            while (running) {
                try {
                    Cousr02cProgram program =
                            new Cousr02cProgram(stubs);
                    program.run(state);
