 ...
 */
public class SectionMain_COTRN00C extends SectionBase {

    public SectionMain_COTRN00C(ParagraphRegistry registry, StubExecutor stubs) {
    ...
    void do_PROCESS_ENTER_KEY(ProgramState state) {
        ...
        if ((!java.util.List.of(" ", "\u0000").contains(state.get("CDEMO-CT00-TRN-SEL-FLG"))) && (!java.util.List.of(" ", "\u0000").contains(state.get("CDEMO-CT00-TRN-SELECTED")))) {
            ...
            if ((java.util.Objects.equals(_evalSubject3, "S")) || (java.util.Objects.equals(_evalSubject3, "s"))) {
                state.addBranch(20);
