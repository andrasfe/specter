...
/**
 * Generated integration tests for Cosgn00cProgram.
 *
...
class Cosgn00cProgramTest {
    ...
    void testRunCompletes() {
        Cosgn00cProgram program = new Cosgn00cProgram();
    ...
    void testDefaultState() {
        Map<String, Object> defaults = Cosgn00cProgram.defaultState();
    ...
    static Stream<TestCaseData> testCases() throws IOException {
        InputStream is = Cosgn00cProgramTest.class.getResourceAsStream("/test_store.jsonl");
        if (is == null) {
            return Stream.empty();
        }
